          ...
          <div className='text-lg mt-4 md:mt-0 md:w-[50%] text-center md:text-left rounded'>
            ...
            <div className='mt-5 justify-evenly text-justify'>
              <p className='text-gray-600 dark:text-gray-300'>
                As a passionate and driven ReactJS developer with a solid foundation in the MERN Stack and NextJS, I am committed to building dynamic, user-focused web applications. I strive to apply my expertise in frontend frameworks, modern UI/UX design, and responsive development while continuously expanding my skills in the fast-paced world of web development. I'm eager to contribute to an innovative team and keep growing with new technologies and challenges.
              </p>
            </div>
          </div>
        </div>
